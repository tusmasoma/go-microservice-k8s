...
import (
	...
	"github.com/tusmasoma/go-microservice-k8s/go/services/catalog/api"
	"github.com/tusmasoma/go-microservice-k8s/go/services/catalog/database/mysql"
...
func BuildContainer(ctx context.Context) (*dig.Container, error) {
	...
	providers := []interface{}{
		...
		config.NewDBConfig,
		pmysql.NewMySQLDB,
		mysql.NewCatalogItem,
		api.NewCatalogService,
	}
