...
func (c *catalogServiceClient) ListCatalogItemsByName(ctx context.Context, in *ListCatalogItemsByNameRequest, opts ...grpc.CallOption) (*ListCatalogItemsByNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, CatalogService_ListCatalogItemsByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogServiceClient) ListCatalogItemsByIDs(ctx context.Context, in *ListCatalogItemsByIDsRequest, opts ...grpc.CallOption) (*ListCatalogItemsByIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CatalogService_ListCatalogItemsByIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
