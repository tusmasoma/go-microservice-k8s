...
import (
	...
	"github.com/tusmasoma/go-microservice-k8s/services/customer/repository/mysql"
...
func main() {
	...
	err = container.Invoke(func(grpcHandler pb.CustomerServiceServer, _ *config.ServerConfig) {
